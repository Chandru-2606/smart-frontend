...
import { getSchoolAdminSummary } from '../../Api/reports';
...
function Dashboard() {
    ...
    useEffect(() => {
        const fetchSummary = async () => {
            setLoading(true);
            try {
                const response = await getSchoolAdminSummary(user.school);
    ...
    return (
        <SnackbarProvider maxSnack={3} autoHideDuration={3000}>
            <Box sx={{
                ...
                <Typography variant="h4" gutterBottom>School Admin Dashboard</Typography>
